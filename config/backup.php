...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Code & config live in Git; the irreplaceable data is the DB
                    // (below) + uploaded media. This keeps backups small & fast.
        ...
        'destination' => [
             ...
             * Env-driven so you can add an offsite disk later, e.g.
             * BACKUP_DISKS=local,s3  (define the disk in config/filesystems.php).
             */
    ...
    'notifications' => [
        'notifications' => [
            // Only the things you'd want to act on — no daily "success" spam.
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFY_EMAIL', 'admin@samutkarshias.in'),
