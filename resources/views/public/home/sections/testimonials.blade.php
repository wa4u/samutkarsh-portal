@php
    ...
    $c = $c ?? [];
    $heading = $c['heading'] ?? 'What students and parents say';
            ...
            <div class="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                @foreach ($items as $t)
                    <figure class="flex flex-col rounded-2xl bg-white p-6 ring-1 ring-slate-200 shadow-sm">
                        ...
                        <blockquote class="mt-3 flex-1 text-sm leading-relaxed text-slate-700 line-clamp-[10]">{!! $t->bodyHtml() !!}</blockquote>
